...
namespace MondoCore.Security.Passwords
{
    ...
    public class PasswordHasher : IPasswordHasher
    {
        ...
        public PasswordHasher(int numIterations, int hashSize = 128, HashAlgorithmName? hashAlgorithmName = null)
        {
            ...
            _hashSize = hashSize;
            _hashAlgorithmName = hashAlgorithmName ?? HashAlgorithmName.SHA3_512;
        }
        ...
        {
            using var hasher = new Rfc2898DeriveBytes(password, salt, _numIterations, _hashAlgorithmName);
